...
public class ThreeSumTests {
    ...
    public void testSortedOutput() {
        ...
        int[] input = {-1, 2, 0, -3, 1, 3};
        List<List<Integer>> expected = Arrays.asList(Arrays.asList(-3, 1, 2), Arrays.asList(-3, 0, 3),
                                                     Arrays.asList(-1, 0, 1));
    ...
    public void testArrayWithDuplicates() {
        ...
        List<List<Integer>> expected = List.of(Arrays.asList(-2, 1, 1));
    ...
    public void testArrayWithZeroTriplet() {
        ...
        int[] input = {1, 3, 0, -1, -3};
        List<List<Integer>> expected = Arrays.asList(Arrays.asList(-3, 0, 3), Arrays.asList(-1, 0, 1));
